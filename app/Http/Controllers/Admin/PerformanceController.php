            ...
            if($request->get_bonus_value=='yes'){
              foreach ($user as $key2 => $value2) { 
                ...
                $bonus = DB::select('SELECT *
                  ...
                  $increase_1 = 0; $increase_2 = 0; $increase_3 = 0; $increase_4 = 0; $increase_5 = 0;
                  if(count($bonus) > 0){
                      $num_1 = $bonus[0]->num_1;
                      $num_2 = $bonus[0]->num_2;
                      $num_3 = $bonus[0]->num_3;
                      ...
                      $amount_1 = $bonus[0]->amount_1;
                      $amount_2 = $bonus[0]->amount_2;
                      $amount_3 = $bonus[0]->amount_3;
                      $amount_4 = $bonus[0]->amount_4;
                      $amount_5 = $bonus[0]->amount_5;

                      $increase_1 = $bonus[0]->increase_5;
                      $increase_2 = $bonus[0]->increase_5;
                      $increase_3 = $bonus[0]->increase_5;
                      $increase_4 = $bonus[0]->increase_5;
                      $increase_5 = $bonus[0]->increase_5;
                  }
                switch ($user[$key2]->rating) {
                    case "5":
                        $user[$key2]->bonus_num = $num_5;//$bonus[0]->num_5;
                        $user[$key2]->bonus_amount = round($amount_5/365*$work_days_bonus,2);
                        $user[$key2]->bonus_increase = round($increase_5/100*$user[$key2]->basic_salary*$work_days_pay,2);
                        break;
                    case "4":
                        $user[$key2]->bonus_num = $num_4;//$bonus[0]->num_4;
                        $user[$key2]->bonus_amount = round($amount_4/365*$work_days_bonus, 2);
                        $user[$key2]->bonus_increase = round($increase_4/100*$user[$key2]->basic_salary*$work_days_pay,2);
                        break;
                    case "3":
                        $user[$key2]->bonus_num = $num_3;//$bonus[0]->num_3;
                        $user[$key2]->bonus_amount = round($amount_3/365*$work_days_bonus,2);
                        $user[$key2]->bonus_increase = round($increase_3/100*$user[$key2]->basic_salary*$work_days_pay,2);
                        break;
                    case "2":
                        $user[$key2]->bonus_num = $num_2;//$bonus[0]->num_2;
                        $user[$key2]->bonus_amount = round($amount_2/365*$work_days_bonus,2);
                        $user[$key2]->bonus_increase = round($increase_2/100*$user[$key2]->basic_salary*$work_days_pay,2);
                        break;
                    case "1":
                        $user[$key2]->bonus_num = $num_1;//$bonus[0]->num_1;
                        $user[$key2]->bonus_amount = round($amount_1/365*$work_days_bonus,2);
                        $user[$key2]->bonus_increase = round($increase_1/100*$user[$key2]->basic_salary*$work_days_pay,2);
                        break;
                    default:
                        $user[$key2]->bonus_num = $num_1;//$bonus[0]->num_1;
                        $user[$key2]->bonus_amount = $amount_1/365*$work_days_bonus;
                        $user[$key2]->bonus_increase = $increase_1/100*$user[$key2]->basic_salary*$work_days_pay;
                        break;
                }
