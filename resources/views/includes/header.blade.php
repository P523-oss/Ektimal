            ...
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <nav class="navbar navbar-expand-lg navbar-light">
                        <a class="navbar-brand main_logo" href="{{url('home')}}"> <img src="img/logo.png" alt="logo"> </a>
                        <a class="navbar-brand single_page_logo" href="{{url('home')}}"> <img src="img/footer_logo.png" alt="logo"> </a>
                        ...
                        <a href="{{url('login')}}" class="d-none d-sm-block btn_1 home_page_btn">Login</a>
                    </nav>
                </div>
            </div>
        </div>
