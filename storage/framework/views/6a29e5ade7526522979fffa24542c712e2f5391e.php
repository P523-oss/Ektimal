                    ...
                    <div class="card m-b-20">
                        <div class="card-body">
                            <div class="" style="padding:25px;">
                                ...
                                <a href="<?php echo e(url('superadmin/editmembership/0')); ?>"><button type="button" class="btn btn-outline-primary waves-effect waves-light"  style="display:inline-block; float:right; font-size:15px;"><i class="mdi mdi-table-edit"></i>&nbsp;New</button>
 </a>
                            </div>
...
<script>
    ...
    function row_delete(id) {
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    url: "<?php echo e(url('superadmin/delete_membership')); ?>",
                    type: 'POST',
                    data: {id:id},
                    // processData:false,
                    // contentType: false,
    ...
    $(document).ready(function() {
        ...
        var manager_datatable = $table.DataTable({
                ...
                "ajax": {
                    "type": "POST",
                    "async": true,
                    "url": '<?php echo e(url("/superadmin/membershiplist")); ?>',
                    "data": {},
                    "dataSrc": "data",
                    "dataType": "json",
                    "cache": false,
                ...
                "columnDefs": [{
                    ...
                    "createdCell": function (td, cellData, rowData, row, col) {
                        var id = ''+cellData+'';
                        html = '<a href="<?php echo e(url('superadmin/editmembership/')); ?>/'+cellData+'"><input class="btn btn-info" type="button" value="Edit"></a> <input class="btn btn-danger" type="button" value="Delete" onclick="row_delete('+cellData+')">'
                        $(td).html(html);
                    }
                }],
