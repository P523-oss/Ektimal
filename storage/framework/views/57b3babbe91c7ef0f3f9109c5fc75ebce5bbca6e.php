                    ...
                    <div class="card m-b-20">
                        <div class="card-body">
                            <div class="" style="padding:25px;">
                                ...
                                <a href="<?php echo e(url('admin/editmanager/0')); ?>"><button type="button" class="btn btn-outline-primary waves-effect waves-light"  style="display:inline-block; float:right;"><i class="mdi mdi-table-edit"></i>&nbsp;New</button>
                                </a>
...
<div id="myModal" class="modal fade bs-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form class="" action="<?php echo e(url('admin/uploadCsvFile')); ?>" autocomplete="on" method="post" role="form">
            ...
            <div class="modal-body">
                <div class="form-group row">
                    <div class="col-md-12 text-center">
                        <a  href="<?php echo e(url('admin/down_temp')); ?>" >
                            Download Template
                        </a>
                    </div>
                </div>
...
<script>
    ...
    function user_delete(id) {
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    url: "<?php echo e(url('admin/delete_user')); ?>",
                    type: 'POST',
                    data: {user_id:id},
                    // processData:false,
                    // contentType: false,
    ...
    $(document).ready(function() {
        ...
        var datatable = $table.dataTable({
            ...
            "ajax": {
                "type": "POST",
                "async": true,
                "url": '<?php echo e(url("/admin/managerlist")); ?>',
                "data": {},
                "dataSrc": "data",
                "dataType": "json",
                "cache": false,
            ...
            "columnDefs": [
                ...
                "createdCell": function (td, cellData, rowData, row, col) {
                    var id = ''+cellData+'';
                    html = '<a href="<?php echo e(url('admin/editmanager/')); ?>/'+cellData+'"><input class="btn btn-info" type="button" value="Edit"></a> <input class="btn btn-danger" type="button" value="Delete" onclick="user_delete('+cellData+')">'
                    $(td).html(html);
                }
            }],
    ...
    function sendfile(){
        ...
        var url = "<?php echo e(url('admin/uploadCsvFile')); ?>";
        $.ajax({
            url: url,
            data: datas,
            cache: false,
