...
<link rel="stylesheet" href="<?php echo e(URL::asset('assets/back/plugins/chartist/css/chartist.min.css')); ?>">
    ...
    <div class="content">
			...
			<div class="container-fluid" style="padding-top:15px;">
		    	<div class="row">
					...
					<a href="<?php echo e(url('admin/manager')); ?>"> 
			            <div class="card mini-stat bg-primary">
			                <div class="card-body mini-stat-img">
			                    ...
			                    <div class="text-white">
			                        ...
			                        <h4 class="mb-4"><?php echo e(isset($total_user) ? $total_user : '0'); ?></h4>
			        ...
			        <div class="col-xl-6 col-md-6">
			        <a href="<?php echo e(url('admin/objective')); ?>"> 
			            <div class="card mini-stat bg-primary">
			                <div class="card-body mini-stat-img">
			                    <div class="mini-stat-icon">
			        ...
			        <div class="col-xl-6 col-md-6">
					<a href="<?php echo e(url('admin/schedule')); ?>"> 
			            <div class="card mini-stat bg-primary">
			                <div class="card-body mini-stat-img">
			                    <div class="mini-stat-icon">
			                        <!-- <i class="mdi mdi-cube-outline float-right"></i> -->
			        ...
			        <div class="col-xl-6 col-md-6">
			        <a href="<?php echo e(url('admin/assign')); ?>"> 
			            <div class="card mini-stat bg-primary">
			                <div class="card-body mini-stat-img">
			                    <div class="mini-stat-icon">
...
<script src="<?php echo e(URL::asset('assets/back/plugins/chartist/js/chartist.min.js')); ?>"></script>
<script src="<?php echo e(URL::asset('assets/back/plugins/chartist/js/chartist-plugin-tooltip.min.js')); ?>"></script>
 <script src="<?php echo e(URL::asset('assets/back/plugins/flot-chart/jquery.flot.min.js')); ?>"></script>
<script src="<?php echo e(URL::asset('assets/back/plugins/flot-chart/jquery.flot.time.js')); ?>"></script>
<script src="<?php echo e(URL::asset('assets/back/plugins/flot-chart/jquery.flot.tooltip.min.js')); ?>"></script>
<script src="<?php echo e(URL::asset('assets/back/plugins/flot-chart/jquery.flot.resize.js')); ?>"></script>
<script src="<?php echo e(URL::asset('assets/back/plugins/flot-chart/jquery.flot.pie.js')); ?>"></script>
<script src="<?php echo e(URL::asset('assets/back/plugins/flot-chart/jquery.flot.selection.js')); ?>"></script>
<script src="<?php echo e(URL::asset('assets/back/plugins/flot-chart/jquery.flot.stack.js')); ?>"></script>
<script src="<?php echo e(URL::asset('assets/back/plugins/flot-chart/curvedLines.js')); ?>"></script>
<script src="<?php echo e(URL::asset('assets/back/plugins/flot-chart/jquery.flot.crosshair.js')); ?>"></script>

<script type="text/javascript">
$(function(){
	$.ajax({
            url: '<?php echo e(url("admin/get_chart")); ?>',
            type: 'POST',
            data: {},  
            async:false,
