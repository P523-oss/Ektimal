...
<div class="content-page">
   ...
   <div class="content">
        <div class="container-fluid" style="padding-top:15px;">
                            ...
                            <div class="row" style="padding:25px;">
                                ...
                                <div class="form-group ">
                                    <select class="form-control " id="year" >
                                        ...
                                        <option value="<?php echo $val->years?>" <?php echo $val->years == date('Y')? 'selected':''; ?>><?php echo $val->years?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                                <div class="col-sm-4"></div>
                                <a href="<?php echo e(url('admin/exportKPI')); ?>"><button class="btn btn-outline-primary waves-effect waves-light" type="button" style="float:right;    margin-right: 5px;" ><span>Export</span></button></a><span></span>
                                <a href="<?php echo e(url('admin/view_chart')); ?>"><button type="button" class="btn btn-outline-primary waves-effect waves-light"  style="display:inline-block; float:right;"><i class="mdi mdi-chart-bar"></i>&nbsp;  View Chart</button>
                                </a>
                            </div>
                    ...
                    <div class="card m-b-20">
                        <div class="card-body">
                            <div class="" style="padding:25px;">
                                ...
                                <a href="<?php echo e(url('admin/exportAll')); ?>"><button class="btn btn-outline-primary waves-effect waves-light" type="button" style="float:right;    margin-right: 5px;" ><span>Export</span></button></a><span></span>
            ...
            <?php if($view_performance == 'allowed'): ?>
            <div class="row">    
                <div class="col-12">
                    <div class="card m-b-20">
                        <div class="card-body">
    ...
    $(document).ready(function() {
        var kpi_datatable = $table.dataTable({
            ...
            "ajax": {
                "type": "POST",
                "async": true,
                "url": '<?php echo e(url("/admin/report_kpi_list")); ?>',
                "data":function(d){
                        return {
                                year:$('#year').val()
                               };
        ...
        var bonus_datatable = $table1.dataTable({
            ...
            "ajax": {
                "type": "POST",
                "async": true,
                "url": '<?php echo e(url("/admin/report_bonus_list")); ?>',
                "data":function(d){
                        return {
                                year:$('#year').val(),
...
function insert_overall_rating(){
    $.ajax({
        url:'<?php echo e(url("/admin/insert_overall_rating")); ?>',
        type: 'POST',
        data: {id:      $('#kpi_id').val(),
