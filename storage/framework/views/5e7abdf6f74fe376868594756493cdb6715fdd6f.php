...
<html lang="en">
    ...
    <body class="kt-page-content-white kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-subheader--enabled kt-subheader--transparent kt-aside--enabled kt-aside--fixed kt-page--loading">
            ...
            <div class="kt-grid kt-grid--hor kt-grid--root kt-login kt-login--v2 kt-login--signin" id="kt_login">
                <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" style="">
                    <div class="kt-grid__item kt-grid__item--fluid kt-login__wrapper">
                        <div class="kt-login__container" style="background-color: white">
                            ...
                            <div class="kt-login__signin">
                                ...
                                <form class="kt-form" action="<?php echo e(url('signin')); ?>" autocomplete="on" method="post" role="form" id="login_form">
                                    <?php if($msg = Session::get('msg')): ?>
                                    <div class="alert alert-warning" role="alert" id="notific">
                                        <strong>Warning! &nbsp;&nbsp;  </strong>  <?php echo e($msg); ?>
                            ...
                            <div class="kt-login__signup">
                                ...
                                <form class="kt-login__form kt-form" action="<?php echo e(url('signup')); ?>" autocomplete="on" method="post" role="form" id="signup_form">
                                    <?php if(Session::get('signup_msg')): ?>
                                    <div class="alert alert-warning" role="alert" id="notific">
                                        <strong>Warning! &nbsp;&nbsp;  </strong>  <?php echo e(Session::get('signup_msg')); ?>

                                    </div>
                                    <?php endif; ?>
                                    <?php if(Session::get('signup_success_msg')): ?>
                                    <div class="alert alert-success" role="alert" id="notific">
                                        <strong>Success! &nbsp;&nbsp;  </strong>  <?php echo e(Session::get('signup_success_msg')); ?>

                                    </div>
                                    <?php endif; ?>
                                    <div class="input-group">
                                        <input class="form-control" type="text" placeholder="UserId" name="username" value="<?php echo old('username'); ?>">
                                    </div>
                                   <?php echo $errors->first('username', '<span class="help-block">:message</span>'); ?>

                                    <div class="input-group">
                                        <input class="form-control" type="text" placeholder="Fullname" name="fullname" value="<?php echo old('fullname'); ?>">
                                    </div>
                                    <?php echo $errors->first('fullname', '<span class="help-block">:message</span>'); ?>

                                    <div class="input-group">
                                        <input class="form-control" type="text" placeholder="Email" name="email" autocomplete="off" value="<?php echo old('email'); ?>">
                                    </div>
                                    <?php echo $errors->first('email', '<span class="help-block">:message</span>'); ?>

                                    <div class="input-group">
                                        <input class="form-control" type="password" placeholder="Password" name="password" value="<?php echo old('password'); ?>">
                                    </div>
                                    ...
                                    <?php echo $errors->first('rpassword', '<span class="help-block">:message</span>'); ?>
        ...
        var s='<?php echo e(Session::get('signup_msg')); ?>';
        if(s!='') {
            var login = $('#kt_login');
                login.removeClass('kt-login--forgot');
                login.removeClass('kt-login--signin');
        ...
        var ss='<?php echo e(Session::get('signup_success_msg')); ?>';
        if(ss!='') {
            var login = $('#kt_login');
                login.removeClass('kt-login--forgot');
                login.removeClass('kt-login--signin');
