                    ...
                    <div class="card m-b-20">
                        <div class="card-body">
                            <div class="" style="padding:25px;">
                                ...
                                <a href="<?php echo e(url('superadmin/editadmin/0')); ?>"><button type="button" class="btn btn-outline-primary waves-effect waves-light"  style="display:inline-block; float:right;"><i class="mdi mdi-table-edit"></i>&nbsp;New</button>
 </a>
                            </div>
...
<script>
    ...
    function user_delete(id) {
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    url: "<?php echo e(url('superadmin/delete_user')); ?>",
                    type: 'POST',
                    data: {user_id:id},
                    // processData:false,
                    // contentType: false,
        ...
        var manager_datatable = $table.DataTable({
                ...
                "columnDefs": [{
                    ...
                    "createdCell": function (td, cellData, rowData, row, col) {
                        var id = ''+cellData+'';
                        html = '<a href="<?php echo e(url('superadmin/editadmin/')); ?>/'+cellData+'"><input class="btn btn-info" type="button" value="Edit"></a> <input class="btn btn-danger" type="button" value="Delete" onclick="user_delete('+cellData+')">'
                        $(td).html(html);
                    }
                }],
                ...
                "columns": [
                    ...
                    {"title": "System Joined", "data": "created_at", "class": "text-center", "width": "10%"},
