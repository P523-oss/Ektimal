    ...
    $(document).ready(function() {
        ...
        var manager_datatable = $table.DataTable({
                ...
                "ajax": {
                    "type": "POST",
                    "async": true,
                    "url": '<?php echo e(url("/employee/evaluation_list")); ?>',
                    "data": {},
                    "dataSrc": "data",
                    "dataType": "json",
                    "cache": false,
                    ...
                    "createdCell": function (td, cellData, rowData, row, col) {
                        ...
                        if(rowData.eval_date !='no'){
                           if(rowData.status == 1 || rowData.status == 2){
                                ...
                                html = '<a href="<?php echo e(url('employee/edit_evaluation/')); ?>/'+cellData+'"><input class="btn btn-info" type="button" value="ReEvaluate"></a>'
                            }else html = '<a href="<?php echo e(url('employee/edit_evaluation/')); ?>/'+cellData+'"><input class="btn btn-info" type="button" value="Evaluate"></a>'
                        }else {
                            html = '<input class="btn btn-secondary waves-effect" type="button" value="Evaluate">'
                        }
