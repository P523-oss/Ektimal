                ...
                <div class="col-12">
                    <div class="card m-b-20">
                        <div class="card-body">
                            ...
                            <form class="" action="<?php echo e(url('admin/insert_cutedate')); ?>" autocomplete="on" method="post" role="form">
                            <div class="row">
                                
                                <input type="hidden" name="id" value="<?php echo isset($cutedate[0])? $cutedate[0]->id:''; ?>">
                                <div class="col-sm-2"></div>
                                <label class="col-sm-2">Pay Increase Cute Date</label>
                                <div class="col-sm-3">
                                    <div class="input-daterange input-group" id="date-range_1">
                                        <input type="text" class="form-control" name="cute_date_pay" required value="<?php echo isset($cutedate[0])? $cutedate[0]->cute_date_pay:date('Y-m-d'); ?>"/>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <div class="input-daterange input-group" id="date-range_2">
                                        <input type="text" class="form-control" name="cute_date_bonus" required value="<?php echo isset($cutedate[0])? $cutedate[0]->cute_date_bonus:date('Y-m-d'); ?>"/>
                                        <div class="input-group-append">
                                            <span class="input-group-text"><i class="mdi mdi-calendar"></i></span>
                                        </div>
                                    </div><!-- input-group -->
